 ...
 */
class EventFormatTest extends UnitTestCase
{
    /**
     * @var \Hda\HdaCommuniteach\Domain\Model\EventFormat|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Hda\HdaCommuniteach\Domain\Model\EventFormat::class,
            ['dummy']
        );
    }
