 ...
 */
class LectureFormatTest extends UnitTestCase
{
    /**
     * @var \Hda\HdaCommuniteach\Domain\Model\LectureFormat|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Hda\HdaCommuniteach\Domain\Model\LectureFormat::class,
            ['dummy']
        );
    }
