 ...
 */
class DidacticConceptTest extends UnitTestCase
{
    /**
     * @var \Hda\HdaCommuniteach\Domain\Model\DidacticConcept|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Hda\HdaCommuniteach\Domain\Model\DidacticConcept::class,
            ['dummy']
        );
    }
