 ...
 */
class EventModeTest extends UnitTestCase
{
    /**
     * @var \Hda\HdaCommuniteach\Domain\Model\EventMode|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Hda\HdaCommuniteach\Domain\Model\EventMode::class,
            ['dummy']
        );
    }
